% Given initialized camera poses and 3D points, refine them by minimizing
% reprojection error.
%
...
function [CSet, RSet, X] = BundleAdjustment(CSet, RSet, X, x, K, traj, V, G)
    ...
    fun = @(params) bundleError(params, CSetEndIndex, QSetEndIndex, XEndIndex, x, K, V, G);
